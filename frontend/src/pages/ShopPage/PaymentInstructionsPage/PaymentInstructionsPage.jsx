...
const PaymentInstructionsPage = () => {
  ...
  // Проверяем, есть ли сумма заказа
  React.useEffect(() => {
    if (!totalAmount) {
      // Если суммы нет, возвращаем пользователя на страницу корзины
      navigate('/cart');
    }
    ...
    <div className={styles.paymentInstructionsPage}>
      ...
      <div className={styles.instructionsContainer}>
        ...
        <ol>
          ...
          <li>
            Способ оплаты:
            <p>Пожалуйста, переведите указанную сумму на следующий банковский счет:</p>
            <ul>
          ...
          <li>
            ...
            <p>После осуществления перевода, пожалуйста, отправьте подтверждение платежа на email:</p>
              <p><strong>koltsovaecoprint@yandex.ru</strong></p> или через любой другой способ связи на нашем сайте.
          </li>
        </ol>
        <h2>Что дальше?</h2>
        ...
        <p>Если у вас возникнут какие-либо вопросы или пожелания, наша команда поддержки всегда готова помочь вам. Не
          стесняйтесь обращаться к нам любым из способов связи указанном внизу сайта или в чате сайта.</p>

...
const PromoPage = () => {
  ...
  return (
    <div className={styles.promo}>
      ...
      <p>Дорогие друзья!</p>
      <p>Рада поделиться мастер-классом «Цветной фон». Это практическое руководство по окрашиванию ткани природными
        красителями — мареной, кошенилью, индиго, кампешем и другими. Результат — живые, неповторимые цвета,

  ...
  return (
    <div className={styles.aboutPage}>
      ...
      <div className={styles.post}>
        ...
        <p>
          Всё началось в 2016 году. В то время было немного информации об этом, почти год самостоятельных не очень удачных
          экспериментов,
          и вот наконец мне повезло: Дина Ронина выпустила мастер-класс и все мои знания и эксперименты сложились в

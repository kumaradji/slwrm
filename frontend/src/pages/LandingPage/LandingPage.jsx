    ...
    <div className={styles.landingPage}>
      ...
      <main>
        ...
        <section className={styles.landingPage__process} aria-labelledby="process-heading">
          ...
          <p>
            Процесс начинается с <strong>подготовки ткани</strong>. Ткань предварительно обрабатывается протравой, содержащей соли
        ...
        <section className={styles.landingPage__plants} aria-labelledby="plants-heading">
          <h1 id="plants-heading">Растения для экопринт</h1>
          <p>
            <strong>Растения играют ключевую роль</strong> в процессе экопринта. Разные виды растений имеют различные свойства окрашивания,
          ...
          <p>
            Например, <em>листья эвкалипта</em> могут создавать оттенки от оливково-зеленого до ярко-оранжевого, а <em>листья ольхи</em> — от
        ...
        <section className={styles.landingPage__lets_magic} aria-labelledby="magic-heading">
          ...
          <p>
            Экопринт предлагает <strong>гармоничный подход к окрашиванию тканей</strong> в сотрудничестве с природой. Он позволяет
            сохранить уникальность и неповторимость каждого изделия, созданного в результате этого процесса. Кроме того,
            такой способ окрашивания является <em>экологически дружественным</em>, поскольку не требует использования химических
          ...
          <p>
            ...
            и если решитесь – приобретайте мой мастер-класс, в котором я подробно рассказываю все тонкости процесса.
          </p>
        </section>

        {!isVIP && (
          <section className={styles.landingPage__bye} aria-labelledby="purchase-heading">
            <h1 id="purchase-heading">Покупайте мастер-класс!</h1>
            {isRegistered ? (
              <>
                <p>
                  Добавьте мастер-класс <strong>"Цветной фон"</strong> в корзину и после оплаты
              ...
              <>
                <p>
                  Если Вы хотите приобрести мастер-класс <strong>"Цветной фон"</strong>, состоящий из девяти видео и подробных
                  конспектов, {' '}
                  <Link
                    to="/auth"

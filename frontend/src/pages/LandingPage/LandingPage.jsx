      ...
      <main>
        ...
        {!isVIP && (
          <section className={styles.landingPage__masterclass} aria-labelledby="masterclass-color-heading">
            ...
            <p>
              Полный видео-курс по натуральному окрашиванию тканей растениями. 9 подробных видеоуроков с конспектами,
              где я делюсь всеми секретами техники экопринт.
            </p>
            <p>
        ...
        {!isVIP2 && (
          <section className={styles.landingPage__masterclass} aria-labelledby="masterclass-graphica-heading">
            ...
            <p>
              Новый мастер-класс по созданию графических композиций в технике экопринт. Сосредоточен на создании четких
              графических линий, геометрических паттернов и сложных орнаментов.
            </p>
            <p>
              Вы научитесь работать с различными типами растительных материалов для достижения максимальной выразительности,
              создавать контрастные композиции и освоите технику графического экопринта.
            </p>
            {isRegistered ? (
              <>
                <Link
                ...
                <p><strong>Цена: 3000 рублей</strong></p>
              </>
            ) : (
              <>
                <p>
